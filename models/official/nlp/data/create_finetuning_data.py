...
flags.DEFINE_enum("classification_task_name", "MNLI",
                  ["COLA", "MNLI", "MRPC", "QNLI", "SST-2", "XNLI", "BDBK", "NER"],
...
def generate_classifier_dataset():
  ...
  processors = {
      ...
      "bdbk": classifier_data_lib.BdbkProcessor,
      "ner" : classifier_data_lib.NerProcessor ,
  }
  ...
  if FLAGS.classification_task_name == "NER":
      processor = processors[task_name](processor_text_fn, FLAGS.input_data_dir)
  else:
